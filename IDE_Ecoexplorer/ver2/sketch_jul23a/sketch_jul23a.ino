  ...
  int DHTPIN = 25;        //Pin de SALIDA sensor DHT22 en el D33 del */
  int vibracionpin = 32;  //Pin de SALIDA sensor digital en el 32 del ESP
  int estadoSensor = 0;
...
/*#define DHTTYPE DHT22
  ...
  void loop() {
    ...
    estadoSensor = digitalRead(vibracionpin);   //Pin de Estaado sendor SW18015P 

    //double mac = ESP.getEfuseMac();
    //Serial.println(ESP.getEfuseMac());

    /* uvString = String(uvvalue);
    ...
    String vibString = String(estadoSensor);
